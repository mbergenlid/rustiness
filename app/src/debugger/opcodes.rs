...
const OP_CODES: [OpCodeDebug; 151] = [
    ...
    OpCodeDebug(nes::opcodes::BRK_IMPLIED           , "BRK_IMPLIED", &|  _,      memory| format!("0x{:x}{:x}", memory.get(0xFFFF), memory.get(0xFFFE))),
    ...
    OpCodeDebug(nes::opcodes::RTI_IMPLIED           , "RTI_IMPLIED", &|_  ,      _| String::new()),
